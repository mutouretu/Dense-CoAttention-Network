    ...
    def _worker():
        while True:
            ...
            if False:
                ...
                img = cv2.cvtColor((cv2.resize(cv2.imread(img_path, cv2.IMREAD_GRAYSCALE), (448, 448))),
                                   cv2.COLOR_BGR2RGB)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_path", default="/home/dengerqiang/Documents/WORK/VQA/images")
    parser.add_argument("--data_name", default="cocoimages")
    parser.add_argument("--data_path", default="/home/dengerqiang/Documents/WORK/VQA/DenseCoAttention")
